...
from PyQt5.QtWidgets import (QWidget, QApplication, QLabel, QLineEdit, QTextEdit, QPushButton, QMessageBox,
...
class AddressBook(QWidget):
    def __init__(self):
        ...
        self.nextButton.clicked.connect(self.nextContact)
        self.previousButton.clicked.connect(self.previousContact)
    ...
    def submitContact(self):
        ...
        if name not in self.contacts:
            ...
            QMessageBox.information(self, "Add Successful",
                                    "\"{}\" has been added to your address book.".format(name))
        else:
            QMessageBox.information(self, "Add Unsuccessful",
                                    "Sorry, \"{}\" is already in your address book".format(name))
            return
